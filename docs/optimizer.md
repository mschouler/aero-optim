...
### Wolf Optimizer
The [`WolfOptimizer`](https://github.com/mschouler/aero-optim/blob/master/src/ins_optimizer.py#L162-L343) class illustrates how `Optimizer` can be inherited to perform a `Wolf`-based optimization.
