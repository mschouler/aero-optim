...
class CustomSimulator(Simulator):
    ...
    #                         or (dict_id["is_init_unsteady_3D"]
    #                         and niter >= self.max_niter_init_3D)
    ...
    #                 self.execute_sim(
    #                     dict_id["meshfile"], dict_id["gid"], dict_id["cid"], dict_id["restart"]
    #                     + 1
    #                 )
    #             else:
    ...
    #                 return self.QoI_convergence(sim_outdir, dict_id), sensors["niter"]
    #             else:
